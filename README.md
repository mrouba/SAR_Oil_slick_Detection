...
![Multi-Temporal SAR Analysis and Algorithmic Mask]
Design sans titre_20260611_180047_0000.jpg

### Key Findings from the Analysis:
* **Before the Spill (Baseline):** The ambient ocean surface shows normal wind roughness, creating a stable, textured gray radar backscatter ranging from **-10 dB to -15 dB**.
